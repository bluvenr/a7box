...
const I18N = {
  en: {
    ...
    'page.description': 'A 100% local, cross-platform developer toolbox — 22 built-in tools. ~10MB, no cloud. Built with Tauri 2 + React 19.',
    ...
    'hero.subtitle': 'An all-in-one developer toolbox that runs <strong>100% locally</strong> — 22 built-in tools in a ~10MB app. No cloud. No tracking. No account required.',
    ...
    'download.desc': 'Download A7Box — 22 tools, ~10MB, no cloud, no account. Just install and use.',
  ...
  zh: {
    ...
    'page.description': '100% 本地运行的跨平台开发者工具箱，内置 22 款工具，~10MB 安装包，无云端依赖。基于 Tauri 2 + React 19 构建。',
    ...
    'hero.title2': '效率武器',
    'hero.title3': '即刻就绪',
    'hero.subtitle': '一款 <strong>100% 本地运行</strong> 的全功能开发者工具箱 —— 22 款内置工具，~10MB 安装包。不联网、不追踪、不需要账号。',
    'hero.download': '立即下载',
    ...
    'download.desc': '下载 A7Box —— 22 款工具，~10MB，无云端，无账号。安装即用。',
...
const TOOL_ICONS = {
  ...
  clipboard: `<svg viewBox="0 0 24 24" ${S}><rect x="8" y="2" width="8" height="4" rx="1"/><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><path d="M12 11h4"/><path d="M12 16h4"/><path d="M8 11h.01"/><path d="M8 16h.01"/></svg>`,
};
...
const TOOLS_I18N = {
  en: [
    ...
    { category: 'Productivity', tools: [
      ...
      { icon: 'clipboard', name: 'Clipboard Manager', desc: 'Encrypted history, quick paste, Paste Stack, snippets & rules' },
    ]},
  ...
  zh: [
    ...
    { category: '效率', tools: [
      ...
      { icon: 'clipboard', name: '剪贴板管理', desc: '加密历史、快捷粘贴、批量粘贴、片段与规则' },
    ]},
    { category: '网络', tools: [
...
const COMPARE_FEATURES_EN = [
  ...
  'Clipboard → floating window', 'Clipboard history manager', 'Screenshot workflow', 'Screen color picker',
