/**
 * Image Convert — Preview Modal with synchronized zoom & pan
 */
import { useState, useEffect, useCallback, useRef } from 'react'
import { useTranslation } from 'react-i18next'
import { X, Download, ZoomIn, ZoomOut, RotateCcw } from 'lucide-react'
import { formatBytes, FORMATS, type ConvertResult } from '../utils'
...
export function PreviewModal({ item, onClose, onDownload }: Props) {
